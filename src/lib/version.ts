...
export const DEPLOYED_COMMIT_MESSAGE =
  "fix(i18n): completely map all exact headings and terminal summaries to prevent English fallback rendering and enforce explicit native MENA typography across all views";
export const DEPLOYED_TIMESTAMP = "2026-06-19T06:52:27Z";
export const DEPLOYED_AUTHOR = "DealCompass Engineering Agent <agent@dealcompass.ai>";
