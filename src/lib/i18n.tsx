...
const DICTIONARY: Translations = {
  ...
  "btn.back": { en: "Back", ar: "رجوع", fa: "بازگشت", ku: "گەڕانەوە", tr: "Geri" },
  ...
  "landing.cta.start": {
    ...
    ar: "ابدأ البحث",
    fa: "شروع جستجو",
    ku: "دەست بە گەڕان بکە",
    tr: "Aramaya başla",
  },
  "landing.badge": {
    en: "Global Trade Intelligence Platform",
    ar: "منصة استخبارات التجارة العالمية",
    fa: "پلتفرم هوش تجارت جهانی",
    ku: "پلاتفۆرمی هەواڵگری بازرگانی جیهانی",
    tr: "Küresel Ticaret İstihbaratı Platformu",
  },
  "landing.hero.dcTitle": {
    en: "Global trade opportunities, discovered by AI.",
    ar: "فرص التجارة العالمية، يكتشفها الذكاء الاصطناعي.",
    fa: "فرصت‌های تجارت جهانی، کشف‌شده با هوش مصنوعی.",
    ku: "هەلەکانی بازرگانی جیهانی، بە ژیری دەستکرد دەدۆزرێنەوە.",
    tr: "Küresel ticaret fırsatları, yapay zeka ile keşfedilir.",
  },
  "landing.hero.dcSubtitle": {
    en: "DealCompass AI+ scans global trade sources, analyzes opportunities, scores leads, and helps you reach the right buyer or supplier faster.",
    ar: "تقوم DealCompass AI+ بمسح مصادر التجارة العالمية وتحليل الفرص وتقييم الجهات لمساعدتك على الوصول إلى المشتري أو المورد المناسب بسرعة.",
    fa: "DealCompass AI+ منابع تجارت جهانی را بررسی می‌کند، فرصت‌ها را تحلیل و سرنخ‌ها را امتیازدهی می‌کند تا سریع‌تر به خریدار یا تامین‌کننده مناسب برسید.",
    ku: "DealCompass AI+ سەرچاوەکانی بازرگانی جیهانی دەگەڕێت، هەلەکان شیکار دەکات و یارمەتیت دەدات زووتر بگەیتە کڕیار یان دابینکەری گونجاو.",
    tr: "DealCompass AI+ küresel ticaret kaynaklarını tarar, fırsatları analiz eder, potansiyel müşterileri puanlar ve doğru alıcıya ya da tedarikçiye daha hızlı ulaşmanıza yardımcı olur.",
  },
  "landing.cta.searchOpps": {
    en: "Start searching opportunities",
    ar: "ابدأ البحث عن الفرص",
    fa: "جستجوی فرصت‌ها را شروع کنید",
    ku: "دەست بە گەڕان بۆ هەلەکان بکە",
    tr: "Fırsat aramaya başla",
  },
  "landing.cta.viewWall": {
    en: "View live opportunity wall",
    ar: "عرض جدار الفرص الحي",
    fa: "مشاهده دیوار فرصت‌های زنده",
    ku: "بینینی دیواری هەلە زیندووەکان",
    tr: "Canlı fırsat duvarını gör",
  },
  "landing.sending": {
    en: "Sending...",
    ar: "جارٍ الإرسال...",
  ...
  "landing.requestAccess": {
    en: "Request early access",
    ar: "طلب وصول مبكر",
    fa: "درخواست دسترسی زودهنگام",
    ku: "داواکاری دەستپێگەیشتنی پێشوەخت",
    tr: "Erken erişim iste",
  },
  "landing.radar": {
  ...
  "landing.radarEngine": {
    en: "Trade Radar Engine",
    ar: "محرك رادار التجارة",
    fa: "موتور رادار تجارت",
    ku: "بزوێنەری ڕاداری بازرگانی",
    tr: "Ticaret Radarı Motoru",
  },
  "landing.radarTitle": {
    en: "We do not wait for opportunities. We go and discover them.",
    ar: "نحن لا ننتظر الفرص؛ بل نذهب ونكتشفها.",
    fa: "ما منتظر فرصت‌ها نمی‌مانیم؛ آن‌ها را کشف می‌کنیم.",
    ku: "ئێمە چاوەڕێی هەلەکان ناکەین؛ دەچین و دەیان دۆزینەوە.",
    tr: "Fırsatları beklemeyiz; gidip keşfederiz.",
  },
  "landing.radarCopy": {
    en: "The radar collects selling offers, buying requests, tenders, manufacturing requests, and surplus production signals from global trade sources.",
    ar: "يجمع الرادار عروض البيع وطلبات الشراء والمناقصات وطلبات التصنيع وإشارات فائض الإنتاج من مصادر التجارة العالمية.",
    fa: "رادار پیشنهادهای فروش، درخواست‌های خرید، مناقصه‌ها، درخواست‌های تولید و سیگنال‌های ظرفیت مازاد را از منابع تجارت جهانی جمع‌آوری می‌کند.",
    ku: "ڕادارەکە پێشنیاری فرۆشتن، داواکاری کڕین، تەندەر، داواکاری بەرهەمهێنان و ئاماژەی بەرهەمهێنانی زیادە لە سەرچاوە جیهانییەکان کۆدەکاتەوە.",
    tr: "Radar; satış tekliflerini, satın alma taleplerini, ihaleleri, üretim taleplerini ve fazla üretim sinyallerini küresel ticaret kaynaklarından toplar.",
  },
  "landing.agentTitle": {
    en: "A virtual sourcing employee working 24/7.",
    ar: "موظف توريد افتراضي يعمل على مدار الساعة.",
    fa: "یک نیروی تأمین مجازی که ۲۴ ساعته کار می‌کند.",
    ku: "کارمەندێکی دابینکردنی مەجازی کە ٢٤/٧ کار دەکات.",
    tr: "7/24 çalışan sanal bir tedarik çalışanı.",
  },
  "landing.agentCopy": {
    en: "Type what you need in natural language. The agent extracts filters, searches the radar, removes weak results, and builds a shortlist.",
    ar: "اكتب ما تحتاجه بلغة طبيعية. يستخرج الوكيل الفلاتر، يبحث في الرادار، يستبعد النتائج الضعيفة، ويبني قائمة مختصرة.",
    fa: "نیاز خود را با زبان طبیعی بنویسید. عامل فیلترها را استخراج می‌کند، در رادار جستجو می‌کند، نتایج ضعیف را حذف می‌کند و فهرست کوتاه می‌سازد.",
    ku: "ئەوەی پێویستتە بە زمانی ئاسایی بنووسە. بریکارەکە فلتەرەکان دەردەهێنێت، لە ڕادار دەگەڕێت و ئەنجامە لاوازەکان لادەبات.",
    tr: "İhtiyacınızı doğal dille yazın. Ajan filtreleri çıkarır, radarda arar, zayıf sonuçları eler ve kısa liste oluşturur.",
  },
  "landing.creditsTitle": {
    en: "Reveal real contacts with Credits.",
    ar: "اكشف بيانات التواصل الحقيقية بالنقاط.",
    fa: "مخاطبین واقعی را با اعتبارها آشکار کنید.",
    ku: "پەیوەندییە ڕاستەقینەکان بە خاڵ ئاشکرا بکە.",
    tr: "Gerçek kişileri kredilerle açın.",
  },
  "landing.creditsCopy": {
    en: "Users can browse opportunity details for free. Company name, decision maker, phone, email, website, and source are unlocked with credits.",
    ar: "يمكن للمستخدمين تصفح تفاصيل الفرص مجاناً. يتم فتح اسم الشركة وصانع القرار والهاتف والبريد والموقع والمصدر باستخدام النقاط.",
    fa: "کاربران می‌توانند جزئیات فرصت‌ها را رایگان ببینند. نام شرکت، تصمیم‌گیرنده، تلفن، ایمیل، وب‌سایت و منبع با اعتبار باز می‌شود.",
    ku: "بەکارهێنەران دەتوانن وردەکاری هەلەکان بەخۆڕایی ببینن. ناوی کۆمپانیا و پەیوەندییەکان بە خاڵ دەکرێنەوە.",
    tr: "Kullanıcılar fırsat detaylarını ücretsiz gezebilir. Şirket adı, karar verici, telefon, e-posta, web sitesi ve kaynak kredilerle açılır.",
  },
  "landing.openApp": {
    en: "Open DealCompass AI+",
    ar: "افتح DealCompass AI+",
    fa: "باز کردن DealCompass AI+",
    ku: "DealCompass AI+ بکەرەوە",
    tr: "DealCompass AI+ aç",
  },
  "landing.footer": {
    en: "© 2026 DealCompass AI+. Global Trade Intelligence Platform.",
    ar: "© 2026 DealCompass AI+. منصة استخبارات التجارة العالمية.",
    fa: "© 2026 DealCompass AI+. پلتفرم هوش تجارت جهانی.",
    ku: "© 2026 DealCompass AI+. پلاتفۆرمی هەواڵگری بازرگانی جیهانی.",
    tr: "© 2026 DealCompass AI+. Küresel Ticaret İstihbaratı Platformu.",
  },
