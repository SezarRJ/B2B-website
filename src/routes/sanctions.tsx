        ...
        <div className="mx-auto max-w-3xl p-6 lg:p-8">
          <div className="rounded-[2rem] border border-amber-200 bg-amber-50 p-8 text-center shadow-sm">
            ...
            <h2 className="text-2xl font-black text-amber-950">
              Real sanctions screening is not available yet
            </h2>
            <p className="mx-auto mt-3 max-w-xl text-sm leading-7 text-amber-800">
              The previous mock screening has been disabled because it did not connect to licensed
              OFAC, EU, UN, or KYC data providers. Configure a real server-side screening provider
              before using this feature for decisions.
            </p>
            <div className="mt-6 rounded-2xl border border-amber-200 bg-white p-4 text-left text-sm text-amber-900">
              <div className="flex gap-3">
                <AlertTriangle className="mt-0.5 h-5 w-5 flex-shrink-0 text-amber-600" />
                <p>
                  Until a real provider is connected, this app must not claim that companies are
                  screened, cleared, approved, or safe for regulated trade.
                </p>
              </div>
            </div>
            <Button
