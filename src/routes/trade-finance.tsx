            ...
            <CardHeader className="pb-3">
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div>
                  ...
                  <CardDescription>
                    DealCompass AI+ orchestrates rigorous financial state machines. Letters of
                    Credit (L/C) are governed by ICC UCP 600 rules, while Documentary Collections
                    (D/P) execute under URC 522 protocols.
                  </CardDescription>
                </div>
