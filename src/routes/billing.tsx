...
function MasterAccountBillingPage() {
  ...
  async function handleCheckout(targetTier: AccountType) {
    ...
    try {
      ...
      setSuccess(
        `Stripe checkout simulated successfully. Upgraded to ${targetTier.toUpperCase()} tier.`,
      );
    } catch (err: any) {
  ...
  const tiers: Array<{
  ...
  }> = [
    {
      ...
      features: [
        ...
        "Max 3 Active Products/Demands",
        "Basic Institutional Escrow Custody",
      ],
    },
    {
      id: "bronze",
      ...
      features: [
        "Standard ML Feature Weights",
        "Max 10 Active Products",
        "Escrow & Documentary Collection (D/P)",
      ],
    },
    {
      id: "silver",
      ...
      features: [
        "Full AI/ML Matching Model Access",
        "Unlimited Active Products/Demands",
        "Dedicated L/C State Machine Routing",
      ],
    },
    {
      id: "gold",
      ...
      features: [
        "Advanced Commodity Price Prediction",
        "Regional Demand Imbalance Alerts",
        "Automated OFAC/EU/UN Sanctions Sweeps",
      ],
      popular: true,
    },
    {
      ...
      features: [
        "Real-Time Container GPS Webhooks",
        "Zero-Trust mTLS Inter-Service Routing",
        "Dedicated Compliance Legal Counsel",
      ],
      vip: true,
    },
    {
      ...
      features: [
        ...
        "Private Sovereign Escrow Pools",
        "Automated Customs Clearance Webhooks",
      ],
      vip: true,
    },
  ];
      ...
      <main className="flex-1 overflow-auto">
        ...
        <div className="p-6 lg:p-8 max-w-6xl mx-auto space-y-8">
            ...
            <CardHeader className="pb-3">
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div>
                  ...
                  <CardDescription>
                    Master Account tiers control matching latency, platform commission, and
                    compliance routing.
                  </CardDescription>
                </div>
              ...
              <div className="grid md:grid-cols-4 gap-4 p-4 bg-white rounded-xl border border-border shadow-sm text-xs">
                <div>
                  ...
                  <span className="font-mono tabular-nums text-muted-foreground">
                    {subscription?.stripe_customer_id || "cus_unregistered_node"}
                  </span>
                </div>
                <div>
                  <span className="font-bold text-foreground block mb-0.5">
                  ...
                  <span className="font-mono tabular-nums text-muted-foreground">
                    {subscription?.stripe_subscription_id || "sub_unregistered_node"}
                  </span>
                </div>
                <div>
                  <span className="font-bold text-foreground block mb-0.5">
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-foreground">Select Master Account Tier</h2>
                  ...
                  >
                    ...
                    <CardHeader className="space-y-2 pb-4">
                      <div>
                        <Badge
                          variant="secondary"
                          className="uppercase font-mono tabular-nums text-[10px] mb-1"
                        >
                          {tier.id}
                        </Badge>
                    ...
                    <CardContent className="space-y-6 pt-0 flex-1 flex flex-col justify-between">
                      <div className="space-y-4">
                        ...
                        <div className="p-3 rounded-lg bg-secondary/50 space-y-1.5 text-xs font-mono tabular-nums">
                          <div className="flex items-center justify-between">
                            <span className="text-muted-foreground">Match Visibility:</span>
                      ...
                      <div className="pt-6 border-t border-border mt-auto">
                        ...
                        >
                          ...
                          {isCurrentTier
                            ...
                            : tier.monthlyPrice === "Custom Quote"
                              ? "Request Black Tier"
                              : `Stripe Checkout (${tier.id.toUpperCase()})`}
                        </Button>
                      </div>
                    </CardContent>
                  </Card>
