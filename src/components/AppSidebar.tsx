...
export function AppSidebar({ activeRoute }: AppSidebarProps) {
  ...
  const items = [
    ...
    {
      id: "profile",
      label: t("nav.profile", "Company Profile"),
      path: "/profile",
      icon: Building2,
    },
    ...
    {
      id: "pre-deals",
      label: t("nav.pre_deals", "Pre-Deals"),
      path: "/pre-deals",
      icon: Handshake,
    },
    {
      id: "orders",
      label: t("nav.orders", "Orders & Escrow"),
      path: "/orders",
      icon: ShoppingCart,
    },
    {
      id: "trade-finance",
      label: t("nav.finance", "Trade Finance (L/C & D/P)"),
      path: "/trade-finance",
      icon: CreditCard,
    },
    {
      id: "shipments",
      label: t("nav.shipments", "Logistics & Tracking"),
      path: "/shipments",
      icon: Truck,
    },
    {
      id: "billing",
      label: t("nav.billing", "Master Account Billing"),
      path: "/billing",
      icon: Globe,
    },
    {
      id: "ml-analytics",
      label: t("nav.analytics", "Smart Trade Analytics"),
      path: "/ml-analytics",
      icon: Sparkles,
    },
    ...
    {
      id: "sanctions",
      label: t("nav.sanctions", "Sanctions Screening"),
      path: "/sanctions",
      icon: Shield,
    },
    {
    ...
    {
      id: "supabase-portal",
      label: t("nav.supabase", "Supabase Core & RLS"),
      path: "/supabase-portal",
      icon: Database,
    },
    {
      id: "microservices-spec",
      label: t("nav.microservices", "Microservices Layout"),
      path: "/microservices-spec",
      icon: Network,
    },
    {
      id: "workflow",
      label: t("nav.workflow", "Trade Workflow Explorer"),
      path: "/workflow",
      icon: Layers,
    },
    {
      id: "hardening-notes",
      label: t("nav.hardening", "HTTPS / Hardening"),
